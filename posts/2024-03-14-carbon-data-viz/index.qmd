...
This plot shows all of the scopes (major project categories) and how many carbon credits have been used by each project scope.
As shown in the plot `Forest & Land Use` and `Renewable Engery`
